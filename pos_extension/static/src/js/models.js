...
exports.PosModel = Backbone.Model.extend({
    initialize: function(session, attributes) {
        ...
        this.units = [];
        this.units_by_id = {};
        // change by thantshweaung for pricelist dropdown 20181023 start
        this.pricelist_arr = [];
         // change by thantshweaung for pricelist dropdown 20181023 end
        this.pricelist = null;
    ...
    ,{
        ...
        fields: ['currency_id'],
        //ids:    function(self){ return [self.config.pricelist_id[0]]; },
        loaded: function(self, pricelists){ self.pricelist_arr = pricelists; },
    }
     // change by thantshweaung for pricelist dropdown 20181023 start
    ,{
        model: 'res.currency',
        ...
        fields: ['display_name', 'burmese_name', 'list_price','price','pos_categ_id', 'taxes_id', 'barcode', 'default_code', 
...
exports.Orderline = Backbone.Model.extend({
    ...
    export_as_JSON: function() {
        ...
        return {
            ...
            product_burmese: this.get_product().burmese_name,
